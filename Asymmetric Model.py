...
def AttnGatingBlock(x, g, inter_shape):
    ...
    upsample_sigmoid_xg = layers.Lambda(upsample_sigmoid_xg, shape_x[1])
...
def unet_model_3d(loss_function, input_shape=(4, 160, 160, 16),
    ...
    conv3 = Conv3D(256, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv32)
    conv3 = concatenate([pool2,conv32, conv3], axis = 1)
    pool3 = MaxPooling3D(pool_size=(2, 2, 2))(conv3)
    pool3 = Dropout(0.25)(pool3)
    conv4 = Conv3D(256, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(pool3)
    conv41 = concatenate([conv4,pool3], axis = 1)
    conv4 = Conv3D(256, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv41)
    conv42 = concatenate([pool3,conv41, conv4], axis = 1)
    conv4 = Conv3D(256, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv42)
    conv42 = concatenate([pool3,conv42, conv4], axis = 1)
    pool4 = MaxPooling3D(pool_size=(2, 2, 2))(conv42)
    pool4 = Dropout(0.25)(pool4)
    conv4 = Conv3D(256, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(pool4)
    conv4 = Conv3D(256, (3, 3, 3),  activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv4)
    ...
    up6 = Conv3DTranspose(128,(3, 3, 3),strides=(2, 2, 2),padding="same")(conv4)
    conv6 = attention_block(up6, conv42, 128)
    merge6 = concatenate([conv6,up6], axis = 1)
    conv6 = Conv3D(128, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(merge6)
    conv6 = Conv3D(128, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv6)
    out1 = Conv3D(128, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv6)
    out1=UpSampling3D(size=(2,2,2))(out1)
    out1=UpSampling3D(size=(2,2,2))(out1)
    out1=UpSampling3D(size=(2,2,2))(out1)
    #### Bloque 2 ####
    
    up7 = Conv3DTranspose(128,(3, 3, 3),strides=(2, 2, 2),padding="same")(conv6)
    ...
    out2=UpSampling3D(size=(2,2,2))(out2)
    out2=UpSampling3D(size=(2,2,2))(out2)
    #### Bloque 3 ####
    
    up8 = Conv3DTranspose(64,(3, 3, 3),strides=(2, 2, 2),padding="same")(conv7)
    conv7 = attention_block(up8, conv2, 64)
    merge8 = concatenate([conv7,up8], axis = 1)
    ...
    conv8= Conv3DTranspose(64,(3, 3, 3),strides=(2, 2, 2),padding="same")(conv8)
    conv9=concatenate([conv8,out2,out1,conv1],axis = 1)
    conv9 = Conv3D(256, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9)
    conv9 = Conv3D(128, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9)
    conv9 = Conv3D(64, (3, 3, 3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9)
    #################### FIN DECODER #########################
    ...
    conv9 = Conv3D(n_labels, (1, 1, 1), activation = activation_name, padding = 'same', kernel_initializer = 'he_normal')(conv9)
